...
import WatchingUpdatesGrid from './WatchingUpdatesGrid';
...
// 修改点：追更提醒弹窗组件，使用网格布局版本的 WatchingUpdatesGrid 组件
  ...
  return createPortal(
    <div className='fixed inset-0 z-[9999] flex items-center justify-center'>
      ...
      <div className='relative z-10 w-full max-w-6xl max-h-[85vh] mx-4 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl overflow-hidden flex flex-col'>
        ...
        {/* 修改点：内容区域 - 使用网格布局版本的 WatchingUpdatesGrid 组件 */}
        <div className='flex-1 overflow-y-auto px-6 py-4'>
          <WatchingUpdatesGrid updates={updates} />
        </div>
      </div>
    </div>,
    document.body
